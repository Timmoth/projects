...
namespace mandelbrot_viewer.OpenGl;

[SuppressMessage("Style", "IDE1006:Naming Styles", Justification = "OpenGL names")]
internal static unsafe class TrampolineFuncs
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexImage1D_t(TextureTarget target, int level, int internalformat, int width, int border,
        PixelFormat format, PixelType type, void* pixels);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexImage2D_t(TextureTarget target, int level, int internalformat, int width, int height,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glReadPixels_t(int x, int y, int width, int height, PixelFormat format, PixelType type,
        void* pixels);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetTexImage_t(TextureTarget target, int level, PixelFormat format, PixelType type,
        void* pixels);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetTexLevelParameterfv_t(TextureTarget target, int level, GetTextureParameter pname,
        float* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetTexLevelParameteriv_t(TextureTarget target, int level, GetTextureParameter pname,
        int* @params);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyTexImage1D_t(TextureTarget target, int level, InternalFormat internalformat, int x,
        int y, int width, int border);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyTexImage2D_t(TextureTarget target, int level, InternalFormat internalformat, int x,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyTexSubImage2D_t(TextureTarget target, int level, int xoffset, int yoffset, int x, int y,
        int width, int height);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexSubImage1D_t(TextureTarget target, int level, int xoffset, int width, PixelFormat format,
        PixelType type, void* pixels);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexSubImage2D_t(TextureTarget target, int level, int xoffset, int yoffset, int width,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawRangeElements_t(PrimitiveType mode, uint start, uint end, int count,
        DrawElementsType type, void* indices);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexImage3D_t(TextureTarget target, int level, int internalformat, int width, int height,
        int depth, int border, PixelFormat format, PixelType type, void* pixels);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexSubImage3D_t(TextureTarget target, int level, int xoffset, int yoffset, int zoffset,
        int width, int height, int depth, PixelFormat format, PixelType type, void* pixels);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyTexSubImage3D_t(TextureTarget target, int level, int xoffset, int yoffset, int zoffset,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTexImage3D_t(TextureTarget target, int level, InternalFormat internalformat,
        int width, int height, int depth, int border, int imageSize, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTexImage2D_t(TextureTarget target, int level, InternalFormat internalformat,
        int width, int height, int border, int imageSize, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTexImage1D_t(TextureTarget target, int level, InternalFormat internalformat,
        int width, int border, int imageSize, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTexSubImage3D_t(TextureTarget target, int level, int xoffset, int yoffset,
        int zoffset, int width, int height, int depth, PixelFormat format, int imageSize, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTexSubImage2D_t(TextureTarget target, int level, int xoffset, int yoffset,
        int width, int height, PixelFormat format, int imageSize, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTexSubImage1D_t(TextureTarget target, int level, int xoffset, int width,
        PixelFormat format, int imageSize, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetCompressedTexImage_t(TextureTarget target, int level, void* img);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBlendFuncSeparate_t(BlendingFactor sfactorRGB, BlendingFactor dfactorRGB,
        BlendingFactor sfactorAlpha, BlendingFactor dfactorAlpha);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glMultiDrawArrays_t(PrimitiveType mode, int* first, int* count, int drawcount);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glMultiDrawElements_t(PrimitiveType mode, int* count, DrawElementsType type, IntPtr indices,
        int drawcount);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveAttrib_t(uint program, uint index, int bufSize, int* length, int* size, uint* type,
        char* name);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveUniform_t(uint program, uint index, int bufSize, int* length, int* size,
        uint* type, char* name);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexAttribPointer_t(uint index, int size, VertexAttribPointerType type, bool normalized,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetTransformFeedbackVarying_t(uint program, uint index, int bufSize, int* length, int* size,
        uint* type, char* name);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexAttribIPointer_t(uint index, int size, VertexAttribPointerType type, int stride,
        void* pointer);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glRenderbufferStorage_t(RenderbufferTarget target, InternalFormat internalformat, int width,
        int height);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetRenderbufferParameteriv_t(RenderbufferTarget target, RenderbufferParameterName pname,
        int* @params);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glFramebufferTexture1D_t(FramebufferTarget target, FramebufferAttachment attachment,
        TextureTarget textarget, uint texture, int level);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glFramebufferTexture2D_t(FramebufferTarget target, FramebufferAttachment attachment,
        TextureTarget textarget, uint texture, int level);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glFramebufferTexture3D_t(FramebufferTarget target, FramebufferAttachment attachment,
        TextureTarget textarget, uint texture, int level, int zoffset);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glFramebufferRenderbuffer_t(FramebufferTarget target, FramebufferAttachment attachment,
        RenderbufferTarget renderbuffertarget, uint renderbuffer);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetFramebufferAttachmentParameteriv_t(FramebufferTarget target,
        FramebufferAttachment attachment, FramebufferAttachmentParameterName pname, int* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGenerateMipmap_t(TextureTarget target);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBlitFramebuffer_t(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0,
        int dstX1, int dstY1, uint mask, BlitFramebufferFilter filter);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glRenderbufferStorageMultisample_t(RenderbufferTarget target, int samples,
        InternalFormat internalformat, int width, int height);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glFramebufferTextureLayer_t(FramebufferTarget target, FramebufferAttachment attachment,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawElementsInstanced_t(PrimitiveType mode, int count, DrawElementsType type, void* indices,
        int instancecount);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyBufferSubData_t(CopyBufferSubDataTarget readTarget, CopyBufferSubDataTarget writeTarget,
        IntPtr readOffset, IntPtr writeOffset, int size);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetUniformIndices_t(uint program, int uniformCount, IntPtr uniformNames,
        uint* uniformIndices);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveUniformsiv_t(uint program, int uniformCount, uint* uniformIndices,
        UniformPName pname, int* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveUniformName_t(uint program, uint uniformIndex, int bufSize, int* length,
        char* uniformName);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveUniformBlockiv_t(uint program, uint uniformBlockIndex, UniformBlockPName pname,
        int* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveUniformBlockName_t(uint program, uint uniformBlockIndex, int bufSize, int* length,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawElementsBaseVertex_t(PrimitiveType mode, int count, DrawElementsType type,
        void* indices, int basevertex);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawRangeElementsBaseVertex_t(PrimitiveType mode, uint start, uint end, int count,
        DrawElementsType type, void* indices, int basevertex);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawElementsInstancedBaseVertex_t(PrimitiveType mode, int count, DrawElementsType type,
        void* indices, int instancecount, int basevertex);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glMultiDrawElementsBaseVertex_t(PrimitiveType mode, int* count, DrawElementsType type,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glFramebufferTexture_t(FramebufferTarget target, FramebufferAttachment attachment,
        uint texture, int level);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexImage2DMultisample_t(TextureTarget target, int samples, InternalFormat internalformat,
        int width, int height, bool fixedsamplelocations);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexImage3DMultisample_t(TextureTarget target, int samples, InternalFormat internalformat,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBlendEquationSeparatei_t(uint buf, BlendEquationModeEXT modeRGB,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBlendFuncSeparatei_t(uint buf, BlendingFactor srcRGB, BlendingFactor dstRGB,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveSubroutineUniformiv_t(uint program, ShaderType shadertype, uint index,
        SubroutineParameterName pname, int* values);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveSubroutineUniformName_t(uint program, ShaderType shadertype, uint index,
        int bufsize, int* length, char* name);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveSubroutineName_t(uint program, ShaderType shadertype, uint index, int bufsize,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetProgramStageiv_t(uint program, ShaderType shadertype, ProgramStagePName pname,
        int* values);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetShaderPrecisionFormat_t(ShaderType shadertype, PrecisionType precisiontype, int* range,
        int* precision);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetProgramBinary_t(uint program, int bufSize, int* length, uint* binaryFormat,
        void* binary);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix2fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix3fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix4fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix2dv_t(uint program, int location, int count, bool transpose,
        double* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix3dv_t(uint program, int location, int count, bool transpose,
        double* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix4dv_t(uint program, int location, int count, bool transpose,
        double* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix2x3fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix3x2fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix2x4fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix4x2fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix3x4fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix4x3fv_t(uint program, int location, int count, bool transpose,
        float* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix2x3dv_t(uint program, int location, int count, bool transpose,
        double* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix3x2dv_t(uint program, int location, int count, bool transpose,
        double* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix2x4dv_t(uint program, int location, int count, bool transpose,
        double* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix4x2dv_t(uint program, int location, int count, bool transpose,
        double* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix3x4dv_t(uint program, int location, int count, bool transpose,
        double* value);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glProgramUniformMatrix4x3dv_t(uint program, int location, int count, bool transpose,
        double* value);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexAttribLPointer_t(uint index, int size, VertexAttribPointerType type, int stride,
        void* pointer);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawArraysInstancedBaseInstance_t(PrimitiveType mode, int first, int count,
        int instancecount, uint baseinstance);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawElementsInstancedBaseInstance_t(PrimitiveType mode, int count, PrimitiveType type,
        void* indices, int instancecount, uint baseinstance);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawElementsInstancedBaseVertexBaseInstance_t(PrimitiveType mode, int count,
        DrawElementsType type, void* indices, int instancecount, int basevertex, uint baseinstance);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetInternalformativ_t(TextureTarget target, InternalFormat internalformat,
        InternalFormatPName pname, int bufSize, int* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetActiveAtomicCounterBufferiv_t(uint program, uint bufferIndex,
        AtomicCounterBufferPName pname, int* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBindImageTexture_t(uint unit, uint texture, int level, bool layered, int layer,
        BufferAccessARB access, InternalFormat format);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexStorage2D_t(TextureTarget target, int levels, InternalFormat internalformat, int width,
        int height);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexStorage3D_t(TextureTarget target, int levels, InternalFormat internalformat, int width,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDrawTransformFeedbackStreamInstanced_t(PrimitiveType mode, uint id, uint stream,
        int instancecount);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glClearBufferData_t(BufferStorageTarget target, InternalFormat internalformat,
        PixelFormat format, PixelType type, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glClearBufferSubData_t(uint target, InternalFormat internalformat, IntPtr offset, int size,
        PixelFormat format, PixelType type, void* data);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyImageSubData_t(uint srcName, CopyBufferSubDataTarget srcTarget, int srcLevel, int srcX,
        int srcY, int srcZ, uint dstName, CopyBufferSubDataTarget dstTarget, int dstLevel, int dstX, int dstY, int dstZ,
        int srcWidth, int srcHeight, int srcDepth);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void
        glFramebufferParameteri_t(FramebufferTarget target, FramebufferParameterName pname, int param);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetFramebufferParameteriv_t(FramebufferTarget target,
        FramebufferAttachmentParameterName pname, int* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetInternalformati64v_t(TextureTarget target, InternalFormat internalformat,
        InternalFormatPName pname, int bufSize, long* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glInvalidateTexSubImage_t(uint texture, int level, int xoffset, int yoffset, int zoffset,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glInvalidateSubFramebuffer_t(uint target, int numAttachments, uint* attachments, int x, int y,
        int width, int height);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glMultiDrawElementsIndirect_t(PrimitiveType mode, DrawElementsType type, void* indirect,
        int drawcount, int stride);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetProgramInterfaceiv_t(uint program, ProgramInterface programInterface,
        ProgramInterfacePName pname, int* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate uint glGetProgramResourceIndex_t(uint program, ProgramInterface programInterface, char* name);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetProgramResourceName_t(uint program, ProgramInterface programInterface, uint index,
        int bufSize, int* length, char* name);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetProgramResourceiv_t(uint program, ProgramInterface programInterface, uint index,
        int propCount, uint* props, int bufSize, int* length, int* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate int glGetProgramResourceLocation_t(uint program, ProgramInterface programInterface, char* name);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate int glGetProgramResourceLocationIndex_t(uint program, ProgramInterface programInterface,
        char* name);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexBufferRange_t(TextureTarget target, InternalFormat internalformat, uint buffer,
        IntPtr offset, int size);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexStorage2DMultisample_t(TextureTarget target, int samples, InternalFormat internalformat,
        int width, int height, bool fixedsamplelocations);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTexStorage3DMultisample_t(TextureTarget target, int samples, InternalFormat internalformat,
        int width, int height, int depth, bool fixedsamplelocations);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureView_t(uint texture, TextureTarget target, uint origtexture,
        InternalFormat internalformat, uint minlevel, uint numlevels, uint minlayer, uint numlayers);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBindVertexBuffer_t(uint bindingindex, uint buffer, IntPtr offset, int stride);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexAttribFormat_t(uint attribindex, int size, uint type, bool normalized,
        uint relativeoffset);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexAttribLFormat_t(uint attribindex, int size, VertexAttribType type,
        uint relativeoffset);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDebugMessageControl_t(DebugSource source, DebugType type, DebugSeverity severity, int count,
        uint* ids, bool enabled);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glDebugMessageInsert_t(DebugSource source, DebugType type, uint id, DebugSeverity severity,
        int length, char* buf);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate uint glGetDebugMessageLog_t(uint count, int bufSize, uint* sources, uint* types, uint* ids,
        uint* severities, int* lengths, char* messageLog);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glClearTexSubImage_t(uint texture, int level, int xoffset, int yoffset, int zoffset,
        int width, int height, int depth, PixelFormat format, PixelType type, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBindBuffersBase_t(BufferTargetARB target, uint first, int count, uint* buffers);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBindBuffersRange_t(BufferTargetARB target, uint first, int count, uint* buffers,
        IntPtr offsets, int* sizes);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void
        glGetTransformFeedbacki64_v_t(uint xfb, TransformFeedbackPName pname, uint index, long* param);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyNamedBufferSubData_t(uint readBuffer, uint writeBuffer, IntPtr readOffset,
        IntPtr writeOffset, int size);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glClearNamedBufferData_t(uint buffer, InternalFormat internalformat, PixelFormat format,
        PixelType type, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glClearNamedBufferSubData_t(uint buffer, InternalFormat internalformat, IntPtr offset,
        int size, PixelFormat format, PixelType type, void* data);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glNamedFramebufferRenderbuffer_t(uint framebuffer, FramebufferAttachment attachment,
        RenderbufferTarget renderbuffertarget, uint renderbuffer);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glNamedFramebufferTexture_t(uint framebuffer, FramebufferAttachment attachment, uint texture,
        int level);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glNamedFramebufferTextureLayer_t(uint framebuffer, FramebufferAttachment attachment,
        uint texture, int level, int layer);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glInvalidateNamedFramebufferSubData_t(uint framebuffer, int numAttachments, uint* attachments,
        int x, int y, int width, int height);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glClearNamedFramebufferfi_t(uint framebuffer, GLEnum buffer, int drawbuffer, float depth,
        int stencil);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glBlitNamedFramebuffer_t(uint readFramebuffer, uint drawFramebuffer, int srcX0, int srcY0,
        int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, uint mask, BlitFramebufferFilter filter);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate FramebufferStatus glCheckNamedFramebufferStatus_t(uint framebuffer, FramebufferTarget target);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetNamedFramebufferParameteriv_t(uint framebuffer, GetFramebufferParameter pname,
        int* param);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetNamedFramebufferAttachmentParameteriv_t(uint framebuffer,
        FramebufferAttachment attachment, FramebufferAttachmentParameterName pname, int* @params);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glNamedRenderbufferStorage_t(uint renderbuffer, InternalFormat internalformat, int width,
        int height);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glNamedRenderbufferStorageMultisample_t(uint renderbuffer, int samples,
        InternalFormat internalformat, int width, int height);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetNamedRenderbufferParameteriv_t(uint renderbuffer, RenderbufferParameterName pname,
        int* @params);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureBufferRange_t(uint texture, InternalFormat internalformat, uint buffer,
        IntPtr offset, int size);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureStorage2D_t(uint texture, int levels, InternalFormat internalformat, int width,
        int height);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureStorage3D_t(uint texture, int levels, InternalFormat internalformat, int width,
        int height, int depth);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureStorage2DMultisample_t(uint texture, int samples, InternalFormat internalformat,
        int width, int height, bool fixedsamplelocations);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureStorage3DMultisample_t(uint texture, int samples, InternalFormat internalformat,
        int width, int height, int depth, bool fixedsamplelocations);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureSubImage1D_t(uint texture, int level, int xoffset, int width, PixelFormat format,
        PixelType type, void* pixels);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureSubImage2D_t(uint texture, int level, int xoffset, int yoffset, int width,
        int height, PixelFormat format, PixelType type, void* pixels);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glTextureSubImage3D_t(uint texture, int level, int xoffset, int yoffset, int zoffset,
        int width, int height, int depth, PixelFormat format, PixelType type, void* pixels);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTextureSubImage1D_t(uint texture, int level, int xoffset, int width,
        PixelFormat format, int imageSize, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTextureSubImage2D_t(uint texture, int level, int xoffset, int yoffset, int width,
        int height, PixelFormat format, int imageSize, void* data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCompressedTextureSubImage3D_t(uint texture, int level, int xoffset, int yoffset,
        int zoffset, int width, int height, int depth, PixelFormat format, int imageSize, void* data);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyTextureSubImage2D_t(uint texture, int level, int xoffset, int yoffset, int x, int y,
        int width, int height);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glCopyTextureSubImage3D_t(uint texture, int level, int xoffset, int yoffset, int zoffset,
        int x, int y, int width, int height);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetTextureImage_t(uint texture, int level, PixelFormat format, PixelType type, int bufSize,
        void* pixels);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetTextureLevelParameterfv_t(uint texture, int level, GetTextureParameter pname,
        float* @params);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetTextureLevelParameteriv_t(uint texture, int level, GetTextureParameter pname,
        int* @params);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexArrayVertexBuffer_t(uint vaobj, uint bindingindex, uint buffer, IntPtr offset,
        int stride);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexArrayVertexBuffers_t(uint vaobj, uint first, int count, uint* buffers, IntPtr offsets,
        int* strides);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexArrayAttribFormat_t(uint vaobj, uint attribindex, int size, VertexAttribType type,
        bool normalized, uint relativeoffset);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexArrayAttribIFormat_t(uint vaobj, uint attribindex, int size, VertexAttribType type,
        uint relativeoffset);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glVertexArrayAttribLFormat_t(uint vaobj, uint attribindex, int size, VertexAttribType type,
        uint relativeoffset);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetQueryBufferObjecti64v_t(uint id, uint buffer, QueryObjectParameterName pname,
        IntPtr offset);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetQueryBufferObjectiv_t(uint id, uint buffer, QueryObjectParameterName pname,
        IntPtr offset);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetQueryBufferObjectui64v_t(uint id, uint buffer, QueryObjectParameterName pname,
        IntPtr offset);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetQueryBufferObjectuiv_t(uint id, uint buffer, QueryObjectParameterName pname,
        IntPtr offset);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetTextureSubImage_t(uint texture, int level, int xoffset, int yoffset, int zoffset,
        int width, int height, int depth, PixelFormat format, PixelType type, int bufSize, void* pixels);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetCompressedTextureSubImage_t(uint texture, int level, int xoffset, int yoffset,
        int zoffset, int width, int height, int depth, int bufSize, void* pixels);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetnTexImage_t(TextureTarget target, int level, PixelFormat format, PixelType type,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glReadnPixels_t(int x, int y, int width, int height, PixelFormat format, PixelType type,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetnColorTable_t(ColorTableTarget target, PixelFormat format, PixelType type, int bufSize,
        void* table);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetnConvolutionFilter_t(ConvolutionTarget target, PixelFormat format, PixelType type,
        int bufSize, void* image);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetnSeparableFilter_t(SeparableTargetEXT target, PixelFormat format, PixelType type,
        int rowBufSize, void* row, int columnBufSize, void* column, void* span);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetnHistogram_t(HistogramTargetEXT target, bool reset, PixelFormat format, PixelType type,
        int bufSize, void* values);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glGetnMinmax_t(MinmaxTargetEXT target, bool reset, PixelFormat format, PixelType type,
        int bufSize, void* values);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glSpecializeShader_t(uint shader, char* pEntryPoint, uint numSpecializationConstants,
        uint* pConstantIndex, uint* pConstantValue);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glMultiDrawArraysIndirectCount_t(PrimitiveType mode, void* indirect, IntPtr drawcount,
        int maxdrawcount, int stride);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void glMultiDrawElementsIndirectCount_t(PrimitiveType mode, uint type, void* indirect,
        IntPtr drawcount, int maxdrawcount, int stride);
