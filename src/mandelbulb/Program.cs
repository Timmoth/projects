...
using mandelbulb_viewer.OpenGl;
...
public static class Program
{
    ...
    private static Mandelbulb? Demo { get; set; }
    ...
    public static async Task Main(string[] args)
    {
        ...
        Demo = new Mandelbulb(gl, vertexShaderSource, fragmentShaderSource);
        Demo?.CanvasResized(CanvasWidth, CanvasHeight);
